import numpy as np
from funciones import discretization, train_nStepsTreeBackup, save_experiment
import sumo_rl
...
for seed in seeds:
    ...
    for episode in range(episodes):
        ...
        # ===== GENERATE EPISODE =====
        Q, episode_reward = train_nStepsTreeBackup(env, initial_state, actions, gamma, alpha, Q, epsilon, method, n)
